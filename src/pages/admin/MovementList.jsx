    ...
    <DashboardLayout>
      ...
      <Modal isOpen={isChallanFormOpen} onClose={() => { setIsChallanFormOpen(false); setSelectedSupervisorId(''); setSupervisorMachines([]); setSelectedMachineIds([]); }} title="Delivery Challan Details">
        <form onSubmit={handleChallanFormSubmit} className="space-y-3 max-h-[70vh] overflow-y-auto pr-1">
          ...
          <p className="pt-2 text-xs font-semibold tracking-wide text-gray-500 uppercase">GST Details</p>
          <div>
            <label className="block mb-1 text-xs font-medium text-gray-600">GST Type</label>
            <select
              className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
          ...
          {challanDetails.gstType !== 'none' && (
            <div>
              <label className="block mb-1 text-xs font-medium text-gray-600">GST Rate (%)</label>
              <select
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
