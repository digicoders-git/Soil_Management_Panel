    ...
    try {
      ...
      if (page2Rows.length > 0) {
        const page2Texts = [
          ...
          ...totalsTexts(250 + page2Rows.length * rowHeight + 4),
        ];
      ...
      if (allSupervisorMachines.length > 0) {
        ...
        alert(`PDF saved & Exit Challan history mein add ho gaya! Challan No: ${challanNo}`);
      }
    } catch (err) {
        ...
        <form onSubmit={handleChallanFormSubmit} className="space-y-4 max-h-[75vh] overflow-y-auto pr-1">
          ...
          {challanSupervisor && (
            <>
              ...
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide pt-1">GST Details</p>
              <div>
